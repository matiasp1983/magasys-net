...
namespace Dyn.Web.Admin
{
    public partial class ListadoDiario : System.Web.UI.Page
    {
        ...
        public void CargarDiario(string criterio, string idProveedor)
        {
            ...
            {
                DataSet ds = lProducto.SeleccionarProductoPorNombrePaginado(criterio, Pagina, ref numeropaginas,0);
                int[] array;
            ...
            {
                DataSet ds = lProducto.SeleccionarProductoPorNombreProveedorPaginado(criterio, idProveedor, Pagina, ref numeropaginas,0);
                int[] array;
                array = new int[numeropaginas];
                CollectionPager.DataSource = array;
                CollectionPager.DataBind();
