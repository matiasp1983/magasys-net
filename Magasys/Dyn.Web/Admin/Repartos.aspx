                ...
                <asp:Panel ID="panSeleccion" runat="server">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="lstProveedores" runat="server" Width="200px" AutoPostBack="True"
                ...
                <asp:Panel ID="panProductos" runat="server" Visible="False">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnBuscarRepartos" runat="server" Text="Buscar Repartos" OnClick="btnBuscarRepartos_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <asp:Panel ID="panListadoRepartos" runat="server" Visible="False">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="style25">
                                <asp:GridView ID="gvRepartos" runat="server" CellPadding="4" ForeColor="#333333"
                        ...
                        <tr>
                            ...
                            <td class="style25">
                                <asp:Button ID="btnImprimir" runat="server" OnClick="btnImprimir_Click" Text="Guardar Listado" />
                            </td>
                            <td>
                                &nbsp;
                            </td>
