<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="true"
    CodeBehind="EditarReservaEdicion.aspx.cs" Inherits="Dyn.Web.Admin.EditarReservaEdicion" %>
                ...
                <table>
                    <tr>
                        ...
                        <td class="tittleprecios03" align="left">
                            <asp:Label ID="lblFechaText" runat="server" Text="<%# Entity.FechaReservaEdicion %>"
