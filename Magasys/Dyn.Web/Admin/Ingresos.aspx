<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="true" CodeBehind="Ingresos.aspx.cs" Inherits="Dyn.Web.Admin.Ingresos" %>
...
<%@ Register src="../controls/WUCBuscarProducto.ascx" tagname="WUCBuscarProducto" tagprefix="uc3" %>
  ...
  <tr>
            <td colspan="2" style="height: 24px">
                ...
                <asp:Button CssClass="adminbutton" ID="btnEliminar" runat="server" Text="Anular"
                    ...
                    OnClientClick="javascript:return confirm('Desea eliminar la Coleccion?');" 
                    Visible="False"/>
            </td>
        </tr>
