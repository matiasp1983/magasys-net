<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="true"
    CodeBehind="ListadoCobro.aspx.cs" Inherits="Dyn.Web.Admin.ListadoCobro" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphCentral" runat="server">
    <!--Inicio Remplazar por el control de búsqueda de clientes-->
    <%--    <asp:Label ID="lblNroCliente" runat="server" Text="N&uacute;mero de cliente:" CssClass="tittleprecios03"> </asp:Label>
    &nbsp;<asp:Label ID="lblNroClienteText" runat="server" Text="3" CssClass="tittleprecios03"> </asp:Label>
    &nbsp;<asp:Label ID="lblNombredeClienteText" runat="server" Text="Nombre de cliente:"
        CssClass="tittleprecios03"></asp:Label>
    &nbsp;<asp:Label ID="lblNombredeCliente" runat="server" Text="Juan Perez" CssClass="tittleprecios03"> </asp:Label>--%>
    <!--Fin Remplazar por el control de búsqueda de clientes-->
    <br />
    <table>
        <tr>
