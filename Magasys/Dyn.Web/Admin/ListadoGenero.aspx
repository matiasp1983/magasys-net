<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin.Master" AutoEventWireup="true"
    CodeBehind="ListadoGenero.aspx.cs" Inherits="Dyn.Web.Admin.ListadoGenero" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="5">
                ...
                <tr>
                    <td colspan="3" class="tittleproducto" width="700" align="left">
                        <h2>
                        Listado de g&eacute;neros</h2>
                    </td>
                </tr>
                <tr>
                    <td width="233" class="tittleprecios03" align="left" valign="middle">
                        Nombre de g&eacute;nero:
                    </td>
                    <td width="234" align="left" valign="middle">
                        <asp:TextBox ID="txtNombreGenero" runat="server" CssClass="tittleprecios03" ValidationGroup="busqueda" Width="234"></asp:TextBox><br />
                        <act:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" MinimumPrefixLength="1"
                            TargetControlID="txtNombreGenero" ServicePath="~/WebService/AutoComplete.asmx"
                ...
                <tr>
                    <td colspan="3" width="700" align="left">
                        <asp:Button ID="btnAdicionarGenero" CssClass="adminbutton" runat="server" Text="Adicionar Género"
